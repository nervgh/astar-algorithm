 ...
 * @param {Function} isGoal It checks: is a node is the goal?
 * @param {Function} getSuccessors It should return an array of successors / neighbors / children
 * @param {Function} distance g(x). It returns the cost of path between two nodes
 * @param {Function} estimate h(x). It returns the cost of path from a node to the goal
 * @return {Array.<*>}
 */
